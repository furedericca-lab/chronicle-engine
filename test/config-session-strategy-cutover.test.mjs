...
describe("sessionStrategy cutover contract", () => {
  ...
  it("rejects removed autoRecallCategories reflection alias", () => {
    assert.throws(
      () =>
        parsePluginConfig({
          ...baseConfig(),
          autoRecallCategories: ["fact", "reflection"],
        }),
      /autoRecallCategories\[\]=reflection is no longer supported in 1\.0\.0-beta\.0; use autoRecallCategories\[\]=behavioral/
    );
  });
