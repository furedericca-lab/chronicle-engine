description: 2026-03-25 design contract snapshot for context-engine-split.
---

# context-engine-split Contracts

Snapshot note:
- this contract records the refreshed 2026-03-25 internal design boundary for the context-engine split;
...
- any older command-triggered generation wording in this snapshot is superseded by `../runtime-architecture.md` and `../remote-memory-backend-2026-03-25/`.
...
- `session_end` / `before_reset` → behavioral session-state cleanup path
