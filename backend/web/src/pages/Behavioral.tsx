...
export function Behavioral() {
  ...
  const behavioralMemories = memoriesData?.items?.filter((m: any) => m.category === 'behavioral' || m.isBehavioral) || []

  return (
    <div>
      <h1 className="page-title">Behavioral Guidance</h1>
      <p className="page-description">Browse behavioral guidance rules for a selected principal.</p>
              ...
              <table>
                ...
                <tbody>
                  ...
                  {behavioralMemories.length === 0 && (
                    <tr>
                      <td colSpan={5} style={{ textAlign: 'center' }}>No behavioral guidance found.</td>
                    </tr>
                  )}
                </tbody>
              </table>
